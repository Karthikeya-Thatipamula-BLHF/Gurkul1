...
export default function Subjects() {
  ...
  const sendToVisionAPI = async (subject, topic, lessonData) => {
    try {
      ...
      console.log("🎬 Ngrok endpoint: https://8c9ce043b836.ngrok-free.app/generate-video");
      ...
      try {
        ...
        if (backendProxyResponse.ok) {
          ...
          try {
            ...
            const ngrokResponse = await fetch("https://8c9ce043b836.ngrok-free.app/generate-video", {
              method: 'POST',
              headers: {
                ...headers,
