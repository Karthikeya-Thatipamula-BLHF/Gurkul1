...
# Get TTS service configuration from environment
TTS_SERVICE_BASE_URL = os.getenv("EXTERNAL_TTS_BASE_URL", "http://192.168.0.119:8001")
TTS_SERVICE_HOST = os.getenv("TTS_SERVICE_HOST", "192.168.0.119")
TTS_SERVICE_PORT = os.getenv("TTS_SERVICE_PORT", "8001")

# Get current service external URL configuration
SUBJECT_GENERATION_EXTERNAL_URL = os.getenv("SUBJECT_GENERATION_EXTERNAL_URL", "http://192.168.0.83:8000")
import uvicorn
import uuid
