...
try:
    ...
    def get_rag_response(query, subject=None):
        return {"response": "RAG service temporarily unavailable", "sources": []}
...
app = FastAPI(
    title="Gurukul Base Backend API",
    description="Core backend service for Gurukul Learning Platform",
    version="1.0.0",
